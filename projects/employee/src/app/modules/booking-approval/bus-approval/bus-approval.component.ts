...
@Component({
  selector: 'app-bus-approval',
  templateUrl: './bus-approval.component.html',
  styleUrls: ['./bus-approval.component.scss']
})
export class BusApprovalComponent implements OnInit {
    searchType = 'hotel';
    navLinks = [];
    pageSize = 10;
  ...
  getBookingList() {
    this.noData=true;
    this.respData=[];
    this.apiHandlerService.apiHandler('busApprovalRequest', 'POST', {}, {}, {}).subscribe(res => {
