...
@Component({
  selector: 'app-bus-mis-downloads',
  templateUrl: './bus-mis-downloads.component.html',
  styleUrls: ['./bus-mis-downloads.component.scss']
})
export class BusMisDownloadsComponent implements OnInit {
