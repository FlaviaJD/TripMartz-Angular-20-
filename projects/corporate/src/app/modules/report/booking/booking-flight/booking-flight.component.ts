    ...
    constructor(
        ...
        if (this.currentUser.auth_role_id == 10) {
            const columnsToAdd: { key: string, value: string }[] = [
                ...
                { key: 'corporate_name', value: 'Finance Name' },
                ...
                { key: 'Phone', value: 'Lead Passenger Phone' },
                ...
                // { key: 'currency', value: 'Currency' }, // Commented out
            ...
            const columnsToAdd: { key: string, value: string }[] = [
                ...
                { key: 'approver_name', value: 'Approvar Name' },
       ...
       let user_type='corporate';
        ...
        if (!this.utility.isEmpty(this.regConfig.value)) {
            reqBody = {
                ...
                "user_type":user_type,
                "EmployeeId":this.regConfig.value.employee_id
            }
        } else {
            reqBody = {}
        }
            ...
            const fileToExport = this.respData.map((response: any,index:number) => {
                if (this.currentUser.auth_role_id == 10) {
                    return {
                        ...
                        "Airline": response['FlightItineraries'][0]['flightBookingTransactionItineraries'][0]['airline_name'],
                        ...
                        "Lead Passenger Email": response.Email,
                        "Lead Passenger Phone": response.Phone,
                        ...
                        "Cancellation Date": response.cancelation_date ? moment(response.cancelation_date).format("MMM DD, YYYY") : 'N/A',
                        "Booked By": response.booked_by,
                        "Booked On": moment(response['FlightItineraries'][0]['flightBookingTransactionItineraries'][0]['created_at']).format("MMM DD, YYYY"),
                    }
                }
                else{
                     return {
                        ...
                        "Status": this.getFormtedStatus(response.BookingStatus),
                        "Approvar Status": response.approvarStatus ? response.approvarStatus : 'PENDING',
