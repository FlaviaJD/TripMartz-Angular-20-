...
@Component({
  selector: 'app-booking-bus-invoice',
  templateUrl: './booking-bus-invoice.component.html',
  styleUrls: ['./booking-bus-invoice.component.scss']
})
export class BookingBusInvoiceComponent implements OnInit {
