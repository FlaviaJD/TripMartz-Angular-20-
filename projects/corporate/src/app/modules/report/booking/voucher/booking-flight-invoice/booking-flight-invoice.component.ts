...
@Component({
  selector: 'app-booking-flight-invoice',
  templateUrl: './booking-flight-invoice.component.html',
  styleUrls: ['./booking-flight-invoice.component.scss']
})
export class BookingFlightInvoiceComponent implements OnInit {
