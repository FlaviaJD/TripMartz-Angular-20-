...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    public doughnutChartLabels:Array<string> = ['Excellent', 'Good', 'Average', 'Dissatisfied'];
    public demodoughnutChartData:Array<number> = [46, 25, 12, 4];
    ...
    public doughnut1ChartLabels:Array<string> = ['Flight', 'Hotel', 'Bus'];
    public demodoughnut1ChartData:Array<number> = [46, 25, 12, 4, 15];
...
function getCartOptions2(respData) {
    return {
        ...
        "series":
            ...
            // {
            //     "name": "Bus",
            //     "data": [67.6, 56.8, 98.5, 93.4, 106.0, 84.5, 105.0, 104.3, 91.2, 83.5, 106.6, 92.3]
