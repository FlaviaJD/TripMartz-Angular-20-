...
@Component({
    selector: 'app-train-approval-template',
    templateUrl: './train-approval-template.component.html',
    styleUrls: ['./train-approval-template.component.scss']
})
export class TrainApprovalTemplateComponent implements OnInit {
