...
import { formatDate } from 'projects/agent/src/app/core/services/format-date';
...
import { ThemeOptions } from 'projects/agent/src/app/theme-options';
...
export class RoundTripComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    ngOnInit() {
     ...
     openModal(index,selectedFlight,flightList,coloumnIndex) {
            this.selectedIndex=index;
            this.selectedFlights=selectedFlight;
    ...
    ViewFareRule(value,booking_source,moreFare){
        this.isModalOpen=false;
        this.moreFare=moreFare;
