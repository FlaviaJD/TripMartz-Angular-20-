...
@Component({
  selector: 'app-bus-booking-steps',
  templateUrl: './bus-booking-steps.component.html',
  styleUrls: ['./bus-booking-steps.component.scss']
})
export class BusBookingStepsComponent implements OnInit {
  ...
  constructor(
    ...
    ngOnInit() {
        const savedTime = localStorage.getItem('agentbusTimer');
    ...
    startTimer(minute: number, initialSeconds) {
        ...
        this.timerInterval = setInterval(() => {
            ...
            this.busService.saveTime(this.display);  // Saving the time (assuming flightService is available)
