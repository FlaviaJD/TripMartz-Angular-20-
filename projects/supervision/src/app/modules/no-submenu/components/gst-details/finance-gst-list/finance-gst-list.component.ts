...
@Component({
    selector: 'app-finance-gst-list',
    templateUrl: './finance-gst-list.component.html',
    styleUrls: ['./finance-gst-list.component.scss']
})
export class FinanceGstListComponent implements OnInit {
