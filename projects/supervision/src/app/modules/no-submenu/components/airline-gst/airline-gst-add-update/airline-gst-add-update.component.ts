...
@Component({
  selector: 'app-airline-gst-add-update',
  templateUrl: './airline-gst-add-update.component.html',
  styleUrls: ['./airline-gst-add-update.component.scss']
})
export class AirlineGstAddUpdateComponent implements OnInit {
    ...
    constructor(
        ...
        private corporateCodeService:AirlineGSTService,
    ) { }
