...
@Component({
  selector: 'app-airline-gst-list',
  templateUrl: './airline-gst-list.component.html',
  styleUrls: ['./airline-gst-list.component.scss']
})
export class AirlineGstListComponent implements OnInit {
