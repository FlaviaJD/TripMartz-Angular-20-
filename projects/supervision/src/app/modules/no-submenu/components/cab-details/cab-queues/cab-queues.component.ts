...
@Component({
    selector: 'app-cab-queues',
    templateUrl: './cab-queues.component.html',
    styleUrls: ['./cab-queues.component.scss']
})
export class CabQueuesComponent implements OnInit {
    ...
    corporateList: string[] = ['HyperMiles PVT.LTD'];
    ...
    showTemplate(data){
        this.router.navigate(['/cab-queues/cab-request'], { state: { data: data } });
    }
    ...
    deleteRequest() {
        ...
        this.apiHandlerService.apiHandler('deleteCar', 'POST', '', '', { id: this.deleteData.UserId, cancellation_remark:this.cancellationRemark }).subscribe(res => {
