...
@Component({
    selector: 'app-agent-slider-image-list',
    templateUrl: './agent-slider-image-list.component.html',
    styleUrls: ['./agent-slider-image-list.component.scss']
})

export class AgentSliderImageListComponent implements OnInit,OnDestroy {
