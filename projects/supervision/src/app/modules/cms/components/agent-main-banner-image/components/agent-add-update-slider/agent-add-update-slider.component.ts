...
@Component({
    selector: 'app-agent-add-update-slider',
    templateUrl: './agent-add-update-slider.component.html',
    styleUrls: ['./agent-add-update-slider.component.scss']
})
export class AgentAddUpdateSliderComponent implements OnInit {
