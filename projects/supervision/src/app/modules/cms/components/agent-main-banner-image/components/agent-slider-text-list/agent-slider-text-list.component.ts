...
@Component({
  selector: 'app-agent-slider-text-list',
  templateUrl: './agent-slider-text-list.component.html',
  styleUrls: ['./agent-slider-text-list.component.scss']
})
export class AgentSliderTextListComponent implements OnInit,OnDestroy {
