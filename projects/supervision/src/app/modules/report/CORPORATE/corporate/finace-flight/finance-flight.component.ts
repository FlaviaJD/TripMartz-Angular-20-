...
@Component({
    selector: 'app-finance-flight',
    templateUrl: './finance-flight.component.html',
    styleUrls: ['./finance-flight.component.scss']
})
export class FinanceFlightComponent implements OnInit, OnDestroy {
