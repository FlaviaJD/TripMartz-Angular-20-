...
@Component({
    ...
    templateUrl: './finance-hotel.component.html',
    styleUrls: ['./finance-hotel.component.scss']
})
export class FinanceHotelComponent implements OnInit {
    ...
    displayColumn: { key: string, value: string }[] = [
        ...
        { key: 'corporateName', value: 'Finace Name' },
