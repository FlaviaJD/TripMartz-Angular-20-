...
import { ViewCarBookingComponent } from './view-car-booking/view-car-booking.component';

const log = new Logger('report/CorporateCarComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];


@Component({
    selector: 'app-corporate-car',
    templateUrl: './corporate-car.component.html',
    styleUrls: ['./corporate-car.component.scss']
})
export class CorporateCarComponent implements OnInit, OnDestroy {
    ...
    exportExcel(): void {
        ...
        const fileToExport = this.respData.map((response: any, index: number) => {
            ...
            return {
                ...
                "Approvar Status": response.CarDetails.ApprovalStatus? response.CarDetails.ApprovalStatus :'Pending',
