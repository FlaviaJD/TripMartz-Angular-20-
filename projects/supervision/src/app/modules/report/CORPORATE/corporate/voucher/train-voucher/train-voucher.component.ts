...
@Component({
  selector: 'app-train-voucher',
  templateUrl: './train-voucher.component.html',
  styleUrls: ['./train-voucher.component.scss']
})

export class TrainVoucherComponent implements OnInit {
