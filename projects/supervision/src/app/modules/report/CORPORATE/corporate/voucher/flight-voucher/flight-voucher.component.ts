...
const baseUrl = environment.b2c_url;
@Component({
...
export class FlightVoucherComponent implements OnInit {
    ...
    barCodeUrl = baseUrl+'/webservice/flight/flightBarCodes/';
...
onPrint(): void {
    ...
    enableSeat() {
        const currentUser = this.utility.readStorage('currentSupervisionUser', localStorage);
