...
@Component({
    selector: 'app-agent-credit-balance',
    templateUrl: './agent-credit-balance.component.html',
    styleUrls: ['./agent-credit-balance.component.scss']
})
export class AgentCreditBalanceComponent implements OnInit, OnDestroy {
