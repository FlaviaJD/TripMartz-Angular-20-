...
@Component({
    selector: 'app-agent-debit-balance',
    templateUrl: './agent-debit-balance.component.html',
    styleUrls: ['./agent-debit-balance.component.scss']
})
export class AgentDebitBalanceComponent implements OnInit {
    ...
    towards = [
        ...
        { id: 6, name: 'F/H Partial Payment' },
        { id: 7, name: 'F/H Date Change ' },
        { id: 8, name: 'Miscellaneouse' }];
    agentForm: FormGroup;
    respData: Array<any> = [];
    agentDetails: any;
    noData: boolean = true;
