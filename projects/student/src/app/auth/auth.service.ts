...
export class AuthService implements OnDestroy {
    ...
    constructor(
        ...
        this.currentUserSubject = new BehaviorSubject<User>(JSON.parse(localStorage.getItem('studentCurrentUser')) || {});
        this.b2bUserSubject = new BehaviorSubject<User>(JSON.parse(localStorage.getItem('studentCurrentUser')) || {});
