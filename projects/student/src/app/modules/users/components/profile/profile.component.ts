...
import { AuthService } from 'projects/student/src/app/auth/auth.service';
...
export class ProfileComponent implements OnInit, OnDestroy {
    ...
    update(value) {
        ...
        localStorage.setItem('studentCurrentUser', JSON.stringify(prevData));
        this.authService.b2bUserSubject.next(JSON.parse(localStorage.getItem('studentCurrentUser')));
    }
