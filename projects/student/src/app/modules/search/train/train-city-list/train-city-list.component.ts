...
@Component({
    selector: 'app-train-city-list',
    templateUrl: './train-city-list.component.html',
    styleUrls: ['./train-city-list.component.scss']
})
export class TrainCityListComponent implements OnInit {
    @Input() getCity = [];
    @Input() inputFor;
