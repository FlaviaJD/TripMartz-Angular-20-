...
export class FlightService implements OnDestroy {
   ...
   // apiList = ['ZBAPINO00015','ZBAPINO00020']; 
    apiList = ['ZBAPINO00002','ZBAPINO00003','ZBAPINO00015','ZBAPINO000026']; 
    callCount: any;
    callCountTP: any;
    currentUser: any;
    ...
    searchResult(data: any) {
        ...
        const created_by_id = this.utility.readStorage('studentCurrentUser', localStorage)['user_id'];
        ...
        if (!data.booking_source || data.booking_source === 'ZBAPINO00002' || data.booking_source === 'ZBAPINO00003' || data.booking_source === 'ZBAPINO00009' || data.booking_source === 'ZBAPINO00008' || data.booking_source === 'ZBAPINO00007') {
            data.UserType = 'B2B';
            data.UserId = this.utility.readStorage('studentCurrentUser', localStorage)['id'];
    ...
    setBookingApiSources(data) {
        ...
        if ((data['PreferredAirlineName'] != 'All') && (data['PreferredAirlineName'] != 'All Airline')) {
            if (data['PreferredAirlines'][0] === 'BS') {
                ...
                this.bookingApiSources = ['ZBAPINO00002','ZBAPINO00002', 'ZBAPINO00007','ZBAPINO00020','ZBAPINO00020','ZBAPINO00003','ZBAPINO000026','ZBAPINO00015'];
            }
        }
        else {
            if (data['JourneyType'] == 'multicity') {
                ...
                this.bookingApiSources = ['ZBAPINO00002','ZBAPINO00002','ZBAPINO00008', 'ZBAPINO00009','ZBAPINO00007','ZBAPINO00020','ZBAPINO00020','ZBAPINO00003','ZBAPINO00015','ZBAPINO000026'];
            }
        }
    ...
    setBookingApiSourceOld(data) {
        ...
        if ((data['PreferredAirlineName'] != 'All') && (data['PreferredAirlineName'] != 'All Airline')) {
            if (data['PreferredAirlines'][0] === 'BS') {
                ...
                this.bookingApiSources = ['ZBAPINO00002','ZBAPINO00002', 'ZBAPINO00007', 'ZBAPINO00003','ZBAPINO000026','ZBAPINO00015']; 
            }
        }
        else {
            if (data['JourneyType'] == 'multicity') {
                ...
                this.bookingApiSources = ['ZBAPINO00002','ZBAPINO00002','ZBAPINO00008', 'ZBAPINO00009', 'ZBAPINO00007', 'ZBAPINO00003','ZBAPINO000026','ZBAPINO00015']; 
            }
        }
        this.bookingApiSources.push('ZBAPINO00011');
        this.bookingApiSources.push('ZBAPINO00012');
    ...
    setTravelomatixBookingApiSources(data) {
        ...
        if (tm_api && tm_api.length > 0 && tm_api[0] != "") {
            this.bookingApiSources = ['ZBAPINO00002','ZBAPINO00002','ZBAPINO00020','ZBAPINO00020','ZBAPINO00003','ZBAPINO000026','ZBAPINO00015'];
    ...
    getEnabledApi() {
          let apiList = this.utility.readStorage('studentCurrentUser', localStorage)['api_list'];
    ...
    showResult(enabledApiList, data, isRoundtrip) {
        ...
        if (this.currentUser && this.currentUser.auth_role_id == 9) {
    ...
    this.setBookingSource(enabledApiList);
    ...
    setBookingSource(enabledApiList) {
        this.bookingApiSources = this.bookingApiSources.filter(item => enabledApiList.includes(item))
    }
    searchResultApi(data) {
       ...
       // this.blockAirline(data);
        ...
        // this.bookingApiSources=['ZBAPINO00015','ZBAPINO000026']
    ...
    updateData(data) {
       // (this.currentUser && this.currentUser.auth_role_id == 8) ? data.CorporateID = 505 : data.CorporateID = +(localStorage.getItem('selectedCorporateId'));
        data.CorporateID = this.currentUser.created_by_id;
