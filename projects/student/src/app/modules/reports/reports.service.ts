...
export class ReportService implements OnDestroy {
    ...
    fetchAgentAccountLedger(): Observable<any> {
        const data = { agent_id: this.utility.readStorage('studentCurrentUser', localStorage)['id'] };
    ...
    fetchDailySalesReport(): Observable<any> {
        const data = { agent_id: this.utility.readStorage('studentCurrentUser', localStorage)['user_id'], offset: 0, limit: 10 };
    ...
    fetchTransactionLogs(): Observable<any> {
        const data = { agent_id: this.utility.readStorage('studentCurrentUser', localStorage)['id'], offset: 0, user_type: 3, limit: 10 };
